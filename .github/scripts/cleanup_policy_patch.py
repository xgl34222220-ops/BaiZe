...
center = Path('v2/app/src/main/java/io/github/xgl34222220/baize/CleanCenterActivity.kt')
...
if center_text.count(needle) != 2:
    raise SystemExit(f'clean center lists: {center_text.count(needle)}')
center.write_text(center_text.replace(needle, replacement))
