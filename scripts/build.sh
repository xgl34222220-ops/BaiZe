...
for p in \
  ...
  CHANGELOG-v0.9.7.md CHANGELOG-v0.9.9.md CHANGELOG-v1.0.0.md CHANGELOG-v1.0.1.md CHANGELOG-v1.0.2.md CHANGELOG-v1.1.0-Beta1.md CHANGELOG-v1.1.0-Beta2.md \
  config webroot; do
  cp -a "$p" "$STAGE/"
done
