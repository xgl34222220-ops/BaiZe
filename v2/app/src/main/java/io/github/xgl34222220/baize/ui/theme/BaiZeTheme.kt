...
fun BaiZeTheme(settings: AppearanceSettings, content: @Composable () -> Unit) {
    ...
    DynamicMaterialTheme(
        ...
        val scheme = if (defaultBlue) generatedScheme.copy(
            ...
            onPrimaryContainer = if (dark) Color(0xFFEBF2FF) else Color(0xFF0B4FD9),
            secondary = if (dark) Color(0xFF60A5FA) else Color(0xFF1E6FFF),
            secondaryContainer = if (dark) Color(0xFF172338) else Color(0xFFEDF4FF),
            onSecondaryContainer = if (dark) Color(0xFFEBF2FF) else Color(0xFF0B4FD9),
            surfaceTint = if (dark) Color(0xFF3B82F6) else Color(0xFF1E6FFF),
            background = if (amoled) Color.Black else if (dark) Color(0xFF121212) else Color(0xFFF7F8FA),
