...
OUTPUT="$OUT/BaiZe-v2.0.2-Module.zip"
...
unzip -p "$OUTPUT" module.prop | grep -q '^version=v2.0.2$'
unzip -p "$OUTPUT" module.prop | grep -q '^versionCode=22320$'
...
echo "已生成白泽 v2.0.2 App 接管版模块：$OUTPUT"
